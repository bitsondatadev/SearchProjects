...
--
-- Create schema tippecanoe_osm
--

CREATE DATABASE IF NOT EXISTS indiana_osm
  DEFAULT CHARACTER SET utf8
  DEFAULT COLLATE utf8_bin;
USE indiana_osm;

--
-- Definition of table `tippecanoe_osm`.`acls`
--

DROP TABLE IF EXISTS `indiana_osm`.`acls`;
CREATE TABLE  `indiana_osm`.`acls` (
...
--
-- Dumping data for table `indiana_osm`.`acls`
--
...
--
-- Definition of table `indiana_osm`.`changeset_tags`
--

DROP TABLE IF EXISTS `indiana_osm`.`changeset_tags`;
CREATE TABLE  `indiana_osm`.`changeset_tags` (
...
--
-- Dumping data for table `indiana_osm`.`changeset_tags`
--
...
--
-- Definition of table `indiana_osm`.`changesets`
--

DROP TABLE IF EXISTS `indiana_osm`.`changesets`;
CREATE TABLE  `indiana_osm`.`changesets` (
  `id` bigint(20) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
  `created_at` datetime NOT NULL,
  `min_lat` DECIMAL(20, 9) default NULL,
  `max_lat` DECIMAL(20, 9) default NULL,
  `min_lon` DECIMAL(20, 9) default NULL,
  `max_lon` DECIMAL(20, 9) default NULL,
...
--
-- Dumping data for table `indiana_osm`.`changesets`
--
...
--
-- Definition of table `indiana_osm`.`current_node_tags`
--

DROP TABLE IF EXISTS `indiana_osm`.`current_node_tags`;
CREATE TABLE  `indiana_osm`.`current_node_tags` (
...
--
-- Dumping data for table `indiana_osm`.`current_node_tags`
--
...
--
-- Definition of table `indiana_osm`.`current_nodes`
--

DROP TABLE IF EXISTS `indiana_osm`.`current_nodes`;
CREATE TABLE  `indiana_osm`.`current_nodes` (
...
--
-- Dumping data for table `indiana_osm`.`current_nodes`
--
...
--
-- Definition of table `indiana_osm`.`current_relation_members`
--

DROP TABLE IF EXISTS `indiana_osm`.`current_relation_members`;
CREATE TABLE  `indiana_osm`.`current_relation_members` (
...
--
-- Dumping data for table `indiana_osm`.`current_relation_members`
--
...
--
-- Definition of table `indiana_osm`.`current_relation_tags`
--

DROP TABLE IF EXISTS `indiana_osm`.`current_relation_tags`;
CREATE TABLE  `indiana_osm`.`current_relation_tags` (
...
--
-- Dumping data for table `indiana_osm`.`current_relation_tags`
--
...
--
-- Definition of table `indiana_osm`.`current_relations`
--

DROP TABLE IF EXISTS `indiana_osm`.`current_relations`;
CREATE TABLE  `indiana_osm`.`current_relations` (
...
--
-- Dumping data for table `indiana_osm`.`current_relations`
--
...
--
-- Definition of table `indiana_osm`.`current_way_nodes`
--

DROP TABLE IF EXISTS `indiana_osm`.`current_way_nodes`;
CREATE TABLE  `indiana_osm`.`current_way_nodes` (
  `id` bigint(64) NOT NULL,
  `node_id` bigint(64) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`current_way_nodes`
--
...
--
-- Definition of table `indiana_osm`.`current_way_tags`
--

DROP TABLE IF EXISTS `indiana_osm`.`current_way_tags`;
CREATE TABLE  `indiana_osm`.`current_way_tags` (
...
--
-- Dumping data for table `indiana_osm`.`current_way_tags`
--
...
--
-- Definition of table `indiana_osm`.`current_ways`
--

DROP TABLE IF EXISTS `indiana_osm`.`current_ways`;
CREATE TABLE  `indiana_osm`.`current_ways` (
  `id` bigint(64) NOT NULL auto_increment,
  `changeset_id` bigint(20) NOT NULL,
  `timestamp` datetime NOT NULL,
  `visible` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`current_ways`
--
...
--
-- Definition of table `indiana_osm`.`diary_comments`
--

DROP TABLE IF EXISTS `indiana_osm`.`diary_comments`;
CREATE TABLE  `indiana_osm`.`diary_comments` (
  `id` bigint(20) NOT NULL auto_increment,
...
--
-- Dumping data for table `indiana_osm`.`diary_comments`
--
...
--
-- Definition of table `indiana_osm`.`diary_entries`
--

DROP TABLE IF EXISTS `indiana_osm`.`diary_entries`;
CREATE TABLE  `indiana_osm`.`diary_entries` (
  `id` bigint(20) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`diary_entries`
--
...
--
-- Definition of table `indiana_osm`.`friends`
--

DROP TABLE IF EXISTS `indiana_osm`.`friends`;
CREATE TABLE  `indiana_osm`.`friends` (
  `id` bigint(20) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`friends`
--
...
--
-- Definition of table `indiana_osm`.`gps_points`
--

DROP TABLE IF EXISTS `indiana_osm`.`gps_points`;
CREATE TABLE  `indiana_osm`.`gps_points` (
...
--
-- Dumping data for table `indiana_osm`.`gps_points`
--
...
--
-- Definition of table `indiana_osm`.`gpx_file_tags`
--

DROP TABLE IF EXISTS `indiana_osm`.`gpx_file_tags`;
CREATE TABLE  `indiana_osm`.`gpx_file_tags` (
...
--
-- Dumping data for table `indiana_osm`.`gpx_file_tags`
--
...
--
-- Definition of table `indiana_osm`.`gpx_files`
--

DROP TABLE IF EXISTS `indiana_osm`.`gpx_files`;
CREATE TABLE  `indiana_osm`.`gpx_files` (
  `id` bigint(64) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`gpx_files`
--
...
--
-- Definition of table `indiana_osm`.`messages`
--

DROP TABLE IF EXISTS `indiana_osm`.`messages`;
CREATE TABLE  `indiana_osm`.`messages` (
  `id` bigint(20) NOT NULL auto_increment,
...
--
-- Dumping data for table `indiana_osm`.`messages`
--
...
--
-- Definition of table `indiana_osm`.`node_tags`
--

DROP TABLE IF EXISTS `indiana_osm`.`node_tags`;
CREATE TABLE  `indiana_osm`.`node_tags` (
  `node_id` bigint(64) NOT NULL,
  `version` bigint(20) NOT NULL,
  `k` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL default '',
  `v` varchar(255) NOT NULL default '',
...
--
-- Dumping data for table `indiana_osm`.`node_tags`
--
...
--
-- Definition of table `indiana_osm`.`nodes`
--

DROP TABLE IF EXISTS `indiana_osm`.`nodes`;
CREATE TABLE  `indiana_osm`.`nodes` (
  `node_id` bigint(64) NOT NULL,
  `latitude` DECIMAL(20, 9) NOT NULL,
  `longitude` DECIMAL(20, 9) NOT NULL,
  `changeset_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`nodes`
--
...
--
-- Definition of table `indiana_osm`.`relation_members`
--

DROP TABLE IF EXISTS `indiana_osm`.`relation_members`;
CREATE TABLE  `indiana_osm`.`relation_members` (
...
--
-- Dumping data for table `indiana_osm`.`relation_members`
--
...
--
-- Definition of table `indiana_osm`.`relation_tags`
--

DROP TABLE IF EXISTS `indiana_osm`.`relation_tags`;
CREATE TABLE  `indiana_osm`.`relation_tags` (
  `relation_id` bigint(64) NOT NULL default '0',
  `k` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL default '',
  `v` varchar(255) NOT NULL default '',
  `version` bigint(20) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`relation_tags`
--
...
--
-- Definition of table `indiana_osm`.`relations`
--

DROP TABLE IF EXISTS `indiana_osm`.`relations`;
CREATE TABLE  `indiana_osm`.`relations` (
  `relation_id` bigint(64) NOT NULL default '0',
  `changeset_id` bigint(20) NOT NULL,
  `timestamp` datetime NOT NULL,
  `version` bigint(20) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`relations`
--
...
--
-- Definition of table `indiana_osm`.`schema_migrations`
--

DROP TABLE IF EXISTS `indiana_osm`.`schema_migrations`;
CREATE TABLE  `indiana_osm`.`schema_migrations` (
  `version` varchar(255) NOT NULL,
  UNIQUE KEY `unique_schema_migrations` (`version`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `indiana_osm`.`schema_migrations`
--

/*!40000 ALTER TABLE `schema_migrations` DISABLE KEYS */;
LOCK TABLES `schema_migrations` WRITE;
INSERT INTO `indiana_osm`.`schema_migrations` VALUES  ('1'),
 ('10'),
 ('11'),
 ('12'),
 ('13'),
...
--
-- Definition of table `indiana_osm`.`sessions`
--

DROP TABLE IF EXISTS `indiana_osm`.`sessions`;
CREATE TABLE  `indiana_osm`.`sessions` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `indiana_osm`.`sessions`
--
...
--
-- Definition of table `indiana_osm`.`user_preferences`
--

DROP TABLE IF EXISTS `indiana_osm`.`user_preferences`;
CREATE TABLE  `indiana_osm`.`user_preferences` (
  `user_id` bigint(20) NOT NULL,
  `k` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`user_preferences`
--
...
--
-- Definition of table `indiana_osm`.`user_tokens`
--

DROP TABLE IF EXISTS `indiana_osm`.`user_tokens`;
CREATE TABLE  `indiana_osm`.`user_tokens` (
  `id` bigint(20) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`user_tokens`
--
...
--
-- Definition of table `indiana_osm`.`users`
--

DROP TABLE IF EXISTS `indiana_osm`.`users`;
CREATE TABLE  `indiana_osm`.`users` (
...
--
-- Dumping data for table `indiana_osm`.`users`
--
...
--
-- Definition of table `indiana_osm`.`way_nodes`
--

DROP TABLE IF EXISTS `indiana_osm`.`way_nodes`;
CREATE TABLE  `indiana_osm`.`way_nodes` (
  `way_id` bigint(64) NOT NULL,
  `node_id` bigint(64) NOT NULL,
  `version` bigint(20) NOT NULL,
  `sequence_id` bigint(11) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`way_nodes`
--
...
--
-- Definition of table `indiana_osm`.`way_tags`
--

DROP TABLE IF EXISTS `indiana_osm`.`way_tags`;
CREATE TABLE  `indiana_osm`.`way_tags` (
...
--
-- Dumping data for table `indiana_osm`.`way_tags`
--
...
--
-- Definition of table `indiana_osm`.`ways`
--

DROP TABLE IF EXISTS `indiana_osm`.`ways`;
CREATE TABLE  `indiana_osm`.`ways` (
  `way_id` bigint(64) NOT NULL default '0',
  `changeset_id` bigint(20) NOT NULL,
  `timestamp` datetime NOT NULL,
  `version` bigint(20) NOT NULL,
...
--
-- Dumping data for table `indiana_osm`.`ways`
--
